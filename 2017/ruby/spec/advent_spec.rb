...
describe Advent do
  ...
  it 'should return 3 from 1122' do
    expect(subject.parse_captcha(1122)).to eq(3)
  end

  it 'should return 4 from 1111' do
    expect(subject.parse_captcha(1111)).to eq(4)
  end

  it 'should return 0 from 1234' do
    expect(subject.parse_captcha(1234)).to eq(0)
  end

  it 'should return 9 from 91212129' do
    expect(subject.parse_captcha(91212129)).to eq(9)
  end
